                ...
                <ul className={styles.aboutItems}>
                    <li className={styles.aboutItem}>
                        ...
                        <div className={styles.aboutItemText}>
                            ...
                            <p>I'm a frontend developer with experience in building responsive and optimized sited</p>
                        </div>
                    </li>
                    <li className={styles.aboutItem}>
                    ...
                    < li className={styles.aboutItem}>
                        ...
                        <div className={styles.aboutItemText}>
                            <h3>UI Designer</h3>
                            <p>
                                I have designed mutliple landing pages and have created design system as well
                            </p>
                        </div>
                    </li>
                </ul>
